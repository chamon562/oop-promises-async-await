...
//     const endpoint = 'https://api.github.com/users/chamon562';
//     //                                       returning same thing auto return info if {}then return.json
    
//     let channee = await fetch(endpoint).then(response => response.json());
//     console.log(channee);
//   }
...
//       let endpoint = 'https://api.github.com/users/romebell'
//       let CendPoint = 'https://api.github.com/users/chamon562'
//       let rome = await fetch(endpoint).then(response =>response.json())
//       console.log(rome)
//       let chan = fetch(CendPoint).then(response => response.json())
//       console.log(chan)
//   }
//   printGit()
//this is same thing up there 
//   fetch(endpoint)
//   .then(response =>{
//       return response.json
//   })
    ...
    // let CendPoint = 'https://api.github.com/users/chamon562'
    //   let chan = await fetch(CendPoint).then(response => response.json())
    //   return response.json
